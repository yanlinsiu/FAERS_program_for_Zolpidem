...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a Random Forest baseline on FAERS global datasets.")
    ...
    parser.add_argument("--train-sample-n", type=int, default=200000, help="Optional sampled training size for faster baseline fitting.")
