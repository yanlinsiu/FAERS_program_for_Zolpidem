...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train an XGBoost baseline on FAERS global datasets."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--n-estimators", type=int, default=400, help="Number of boosting rounds."
    )
    ...
    cv_metrics = run_cross_validation(
        build_pipeline=lambda: build_pipeline(
            args.n_estimators,
            args.max_depth,
            args.learning_rate,
            scale_pos_weight,
