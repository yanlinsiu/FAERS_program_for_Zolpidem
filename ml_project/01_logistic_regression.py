...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a Logistic Regression baseline on FAERS global datasets.")
    ...
    parser.add_argument("--train-sample-n", type=int, default=400000, help="Optional sampled training size for faster baseline fitting.")
    ...
    print(f"Saved Logistic Regression outputs to: {run_dir}")
